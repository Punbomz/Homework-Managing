  ...
  <body>
    <?php require('navbar.php'); ?>
	  ...
	  <div class="container text-center justify-content-center col-12">
		  <h1 class="text-center m-5">เข้าสู่ระบบ</h1>
	  </div>
		  ...
		  <div class="row justify-content-center">
			<div class="jumbotron p-4 col-8">
				<form class="form-group" action="logincheck.php" method="post">
					...
					<div class="row justify-content-center"><button type="submit" class="btn-primary form-control w-auto">เข้าสู่ระบบ</button></div>
				</form>
			</div>
			  </div>
